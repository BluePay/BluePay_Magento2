...
use Fiserv\Payments\Gateway\Command\Bluepay\GetPaymentTokenCommand;
...
/**
 * Class GetBluepayToken
 */
class GetBluepayToken extends Action
{
	/**
	 * @var LoggerInterface
	 */
	...
	public function execute()
	{
		...
		try {
			...
			$result = $this->command->execute(
				...
				->get();
			$response->setData(['paymentToken' => $result['paymentToken']]);
		} catch (\Exception $e) {
